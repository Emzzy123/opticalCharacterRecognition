...
def lambda_handler(event, context):
    ...
    s3BucketName = "react-ap-ocr-images"
    ...
    #Pulling invoice number data and filtering out any suspicious characters
    
    str_Invoice = str(re.findall('(?i)invoice\s*[#|number|num|Number]+[\s][\d|\w|_,-|A-Za-z]+',processedResult)) 
